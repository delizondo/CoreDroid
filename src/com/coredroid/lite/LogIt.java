...
import com.coredroid.BuildConfig;
...
public class LogIt {
     ...
     * email address. This needs to be small enough that the logs do not get too
     * close to 1Mb, otherwise we'll hit a TransactionTooLargeException when
     * launching the email application with our logs in the intent.
     */
    ...
    /**
     * User level logs to indicate that the user has carried out an action in
     * the UI, e.g. touching a button.
     */
    ...
    /**
     * Error level logs to indicate a serious error, or a programming mistake
     * has occurred.
     */
     ...
     * time for all logs: adb logcat -v threadtime
     */
    ...
    /**
     * Return whether the app should save logs so the user can email them to us.
     */
